...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
   Double controllerJoystickDeadzone = 0.1; 

    if (controller.getYLeftDriver() > controllerJoystickDeadzone){
      drive.RightDrive(controller.getYLeftDriver() - (controller.getXRightDriver()));
      drive.LeftDrive(controller.getYLeftDriver() + (controller.getXRightDriver()));
    ...
    }else if(controller.getLeftTriggerDriver() > 0.1) {
      drive.RightDrive(controller.getLeftTriggerDriver());
      drive.LeftDrive(controller.getLeftTriggerDriver());
    } else {
      drive.LeftDrive(0);
      drive.RightDrive(0);
     } 
